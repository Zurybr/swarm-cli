...
describe('Example: Testing a Code Review Skill', () => {
    ...
    const harness = new testing_1.SkillTestHarness((llm) => new CodeReviewSkill(llm));
    ...
    describe('Security testing with guardrails', () => {
        it('detects and blocks prompt injection attempts', async () => {
            ...
            harness.withGuardrail(new testing_1.PromptInjectionGuardrail());
            ...
            await expect(harness.whenSkillExecutes(maliciousInput)).rejects.toThrow('Guardrail \'PromptInjectionDetection\' blocked');
        ...
        it('allows safe code through guardrails', async () => {
            ...
            harness
                .withGuardrail(new testing_1.PromptInjectionGuardrail())
    ...
    describe('Advanced: Multiple fixtures and assertions', () => {
        ...
        it('verifies LLM call count for multi-step skills', async () => {
            ...
            const multiStepHarness = new testing_1.SkillTestHarness((llm) => new MultiStepReviewSkill(llm));
    ...
    describe('Best practices summary', () => {
        it('demonstrates complete test setup pattern', async () => {
            ...
            const testHarness = new testing_1.SkillTestHarness((llm) => new CodeReviewSkill(llm));
            ...
            testHarness.withGuardrail(new testing_1.PromptInjectionGuardrail());
...
describe('Example: Common testing patterns', () => {
    it('pattern: Testing error handling', async () => {
        ...
        const harness = new testing_1.SkillTestHarness((llm) => new ErrorProneSkill(llm));
    ...
    it('pattern: Testing with multiple guardrails', async () => {
        const harness = new testing_1.SkillTestHarness((llm) => ({
            execute: async (input) => {
        ...
        harness
            .withGuardrail(new testing_1.PromptInjectionGuardrail())
            .withGuardrail(new testing_1.PromptInjectionGuardrail()); // Duplicate for demo
...
//# sourceMappingURL=example-skill.test.js.map
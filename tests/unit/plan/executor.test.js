...
const executor_1 = require("@/plan/executor");
function createExecutablePlan(overrides = {}) {
    return {
        metadata: {
            phase: '01-test',
            plan: '01',
...
describe('PlanExecutor', () => {
    describe('executePlan', () => {
        it('should execute a simple plan', async () => {
            ...
            const result = await (0, executor_1.executePlan)(plan, context);
        ...
        it('should emit progress events', async () => {
            ...
            await (0, executor_1.executePlan)(plan, context, (event) => {
    ...
    describe('PlanExecutor class', () => {
        it('should execute a plan using class method', async () => {
            const executor = new executor_1.PlanExecutor();
            const plan = createExecutablePlan();
            const context = createExecutionContext();

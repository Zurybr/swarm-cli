...
const validator_1 = require("@/plan/validator");
...
describe('PlanValidator', () => {
    describe('validatePlan', () => {
        it('should validate a correct plan', () => {
            ...
            const result = (0, validator_1.validatePlan)(plan);
    ...
    describe('PlanValidator class', () => {
        it('should validate a single plan', () => {
            const validator = new validator_1.PlanValidator();
            const plan = createValidPlan();
        ...
        it('should detect missing cross-plan dependencies', () => {
            ...
            expect(results.get('01-test-02')?.errors.some(e => e.code === 'MISSING_DEPENDENCY')).toBe(true);
        });
    });
});

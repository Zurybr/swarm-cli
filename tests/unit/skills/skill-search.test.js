...
const search_index_1 = require("../../../src/skills/registry/search-index");
const skill_store_1 = require("../../../src/skills/registry/skill-store");
describe('SkillSearchIndex', () => {
    ...
    beforeEach(async () => {
        ...
        store = new skill_store_1.SkillStore(db);
        searchIndex = new search_index_1.SkillSearchIndex(db);
    ...
    const createSkill = (name, description, version = '1.0.0') => ({
        name,
        description,
        version,
        category: 'general',
